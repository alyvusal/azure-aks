...
```log
time="2020-08-24T11:30:54Z" level=info msg="Updating A record named 'eapp1' to '20.37.141.33' for Azure DNS zone 'example.com'."
time="2020-08-24T11:30:55Z" level=info msg="Updating TXT record named 'eapp1' to '\"heritage=external-dns,external-dns/owner=default,external-dns/resource=ingress/default/nginxapp1-ingress-service\"' for Azure DNS zone 'example.com'."
```

### Verify Record Set in DNS Zones -> example.com

- Go to All Services -> DNS Zones -> example.com
- Verify if we have `eapp1.example.com` created
...
az network dns record-set a list -g dns-zones -z example.com
```
...
```t
# nslookup Test
user$ nslookup eapp1.example.com
Server: 192.168.0.1
Address: 192.168.0.1#53

Non-authoritative answer:
Name: eapp1.example.com
Address: x.x.x.x
```
...
```t
# Access Application
http://eapp1.example.com
http://eapp1.example.com/app1/index.html
...
```log
time="2024-08-24T15:22:44Z" level=info msg="Deleting A record named 'eapp1' for Azure DNS zone 'example.com'."
time="2024-08-24T15:22:45Z" level=info msg="Deleting TXT record named 'eapp1' for Azure DNS zone 'example.com'."
```
